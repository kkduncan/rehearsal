...
namespace kd
{
    ...
    protected:
        /// Get the maximum value
        const T getMax(typename RBNode::Ptr node) const;
        
        /// Get the minimum value
        const T getMin(typename RBNode::Ptr node) const;
        
        /// Get the elements of the tree via Pre-Order traversal
        void getElementsPreOrder(typename RBNode::Ptr node, std::vector<T>& elems) const;
        
        /// Get the elements of the tree via In-Order traversal
        void getElementsInOrder(typename RBNode::Ptr node, std::vector<T>& elems) const;
        
        /// Get the elements of the tree via Post-Order traversal
        void getElementsPostOrder(typename RBNode::Ptr node, std::vector<T>& elems) const;
        
        /// Get the elements of the tree via Level-Order traversal
        void getElementsLevelOrder(typename RBNode::Ptr node, std::vector<T>& elems) const;
